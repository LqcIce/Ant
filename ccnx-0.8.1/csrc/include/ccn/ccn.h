...
enum ccn_parsed_ant_offsetid {
    CCN_PA_B_Name,
    CCN_PA_B_Component0,
    CCN_PA_B_LastPrefixComponent,
    CCN_PA_E_LastPrefixComponent,
    CCN_PA_E_ComponentLast = CCN_PA_E_LastPrefixComponent,
    CCN_PA_E_Name,
    CCN_PA_B_MinSuffixComponents,
    CCN_PA_E_MinSuffixComponents,
    CCN_PA_B_MaxSuffixComponents,
    CCN_PA_E_MaxSuffixComponents,
    CCN_PA_B_PublisherID, // XXX - rename
    CCN_PA_B_PublisherIDKeyDigest,
    CCN_PA_E_PublisherIDKeyDigest,
    CCN_PA_E_PublisherID,
    CCN_PA_B_Exclude,
    CCN_PA_E_Exclude,
    CCN_PA_B_ChildSelector,
    CCN_PA_E_ChildSelector,
    CCN_PA_B_AnswerOriginKind,
    CCN_PA_E_AnswerOriginKind,
    CCN_PA_B_Scope,
    CCN_PA_E_Scope,
    CCN_PA_B_Time,
    CCN_PA_E_Time,
    CCN_PA_B_InterestLifetime,
    CCN_PA_E_InterestLifetime,
    CCN_PA_B_Nonce,
    CCN_PA_E_Nonce,
    CCN_PA_B_OTHER,
    CCN_PA_E_OTHER,
...
struct ccn_parsed_ant {
    ...
    int scope;
    int time;
    unsigned short offset[CCN_PA_E+1];
};
////////////////////by  ice/////////////////////////////
 ...
 */
#define CCN_AOK_CS      0x1     /* Answer 0000 0001from content store */
...
intmax_t ccn_ant_lifetime(const unsigned char *msg,
                               const struct ccn_parsed_ant *pa);
///////////////////////////////////////////////////////
